...
def test_dimensional_EOMS():
    ...
    assert np.isclose(final_state, [ 1.48109206e+11, -5.32205049e+03,  0.00000000e+00,  2.21611267e-01, -2.64256808e-02,  0.00000000e+00]).all()
...
def test_EOM_constructor():
    ...
    final_state = solution.y.T[-1]
    assert np.isclose(final_state, [ 8.37055164e-01, -8.15798446e-05,  0.00000000e+00,  5.13004292e-04, -2.39580318e-04, 0.00000000e+00]).all()
